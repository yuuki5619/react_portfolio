        ...
        >
          <header className="text-gray-50 bg-slate-400 ">
            <div className="container flex mx-auto p-5 flex-col md:flex-row items-center">
              ...
              <nav className="md:ml-auto text-base">
                <a
                  href="#home"
                  className="mr-5 hover:text-blue-200 duration-300"
                >
                  home
                </a>
                <a
          ...
          >
            <div className="container px-5 py-24 mx-auto">
              <div className=" mb-20 text-center md:text-left">
                <h1 className="text-2xl sm:text-5xl font-medium mb-2 text-gray-500 ">
                  About
                </h1>
                <p className="py-10">佐藤佑樹</p>
                <p>1994年、埼玉県さいたま市出身</p>
                <p className="py-10 leading-8">
                  2018年にインフラエンジニアとしてデータベースを担当。主にOracleやHiRDBの設計、構築を担当する。
                  その後、開発を行いたく、bashシェルなどで運用ツール作成の業務を行う。
                  2022年からServiceNow上でのJavaScriptを使用した認証登録処理や、遠隔コマンド発行機能を開発。
                  また、ポータルサイトへのユーザ一覧画面などフロントエンドを経験し、フロントエンドの魅力を知る。
                  今後はフロントエンドエンジニアとして
                  スキルアップし、魅力的で使いやすいユーザーインターフェースでユーザーに喜びを提供したいと考えています。
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="container px-5 py-24 mx-auto">
              ...
              <div className="flex flex-wrap items-center justify-center ">
                <div className="md:w-1/3 p-4">
                  <div className="bg-gray-200 rounded-lg p-8 md:w-fit">
                    <div className="flex items-center mb-3 justify-center">
                      ...
                      <h2 className="text-gray-500 text-lg font-medium ml-2 text-center">
                        簡易SNSアプリ
                      </h2>
                    </div>
                    <div>
                      <h4 className="text-center mt-5 ">詳細</h4>
                      <p className="text-sm mt-3 text-center ">
                        MongoDB×Express×React×Node.jsのフルスタック技術を使ってSNSアプリを１から構築
                      </p>
                      <br />
                      <h4 className="text-center ">使用技術</h4>
                      <p className="mt-3 text-sm text-center">
                        React.js、Node.js、Express、MongoDB
                      </p>
                      <a
                        href="/"
                        className="flex mt-3 text-blue-500 items-center justify-center"
                      >
                        Coomig Soon...
                        <svg
                          width="24"
          ...
          >
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
              <div className="mb-5 lg:mb-0 w-full lg:w-1/2 flex justify-center lg:justify-start">
